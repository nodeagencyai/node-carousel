...
// Row spacing for list-bullet: 88px (≈ line of type at 36px body-large with breathing)
...
const values = {
  ...
  // Cumulative row offsets for the 5 rows (0, 88, 176, 264, 352)
  ROW_SPACING_BULLET: ROW_SPACING,
  ROW_SPACING_BULLET_2: ROW_SPACING * 2,
  ROW_SPACING_BULLET_3: ROW_SPACING * 3,
  ROW_SPACING_BULLET_4: ROW_SPACING * 4,
